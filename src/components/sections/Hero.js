  ...
  return (
    <section id="home" className="relative pt-24 pb-32 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10 text-center">
        ...
        {/* Headline from your HTML + Platform Vibe */}
        <h1 className="text-5xl md:text-7xl font-extrabold text-white tracking-tight mb-6 leading-tight">
          We turn vision into <br className="hidden md:block" />
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-pink via-brand-rose to-blue-600">
            velocity.
          </span>
        </h1>

        {/* Subheadline from your HTML */}
        ...
        {/* Dual CTA - Platform Entry Points */}
        ...
        <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-4 border-t border-white/10 pt-8">
          {[
            ...
            { label: "Startups Listed", value: "1.2k+" },
            { label: "Deals Closed", value: "$50M+" },
